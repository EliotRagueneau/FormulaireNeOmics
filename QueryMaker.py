...
# to /net/cremi/eragueneau/.Tulip-5.2/plugins/python
...
class NeOmics(tlp.ImportModule):
  def __init__(self, context):
    ...
    self.addDirectoryParameter("Directory path", defaultValue="/net/stockage/PdP_BioInfo_2019/Gallardo_Ragueneau_Lambard/Ressources", isMandatory=True, help="The path to the file")
  ...
  def importGraph(self):
    ...
    MORCEAU = tk.PhotoImage(file=resources + "/morceau.png")
    NODES_IMG = {"Tissue": tk.PhotoImage(file=resources + "/Tissue.png"),
                 "Analysis" : tk.PhotoImage(file=resources + "/Analysis.png"),
                 "Experience": tk.PhotoImage(file=resources + "/Exp.png"),
                 "TF": tk.PhotoImage(file=resources + "/TF.png"),
                 "GOI": tk.PhotoImage(file=resources + "/GOI.png"),
                 "Gene": tk.PhotoImage(file=resources + "/Gene.png"),
                 "Protein" : tk.PhotoImage(file=resources + "/Protein.png"),
                 "Annotation" : tk.PhotoImage(file=resources + "/Annot.png"),
                 "Group": tk.PhotoImage(file=resources + "/Group.png"),
                 "Unknown": tk.PhotoImage(file=resources + "/Unknown_node.png")
    ...
    tk.Button(root,text="Send",command=import_from_query).pack()
    ...
    class Line:
        ...
        def __init__(self):
            ...
            self.add_button = tk.Button(self.frame, image=ADD_ICON, relief='flat', command=self.new_line, bg=BG_COLOR,
        ...
        def update_name_list(self):
            ...
            completion_list = {result['a.name'] for result in neo_graph.run(name_query) if result['a.name'] is not None}
...
tulipplugins.registerPlugin("NeOmics", "Query Maker", "", "11/05/2019", "", "1.0")
